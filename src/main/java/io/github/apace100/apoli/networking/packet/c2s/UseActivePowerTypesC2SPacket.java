...
public record UseActivePowerTypesC2SPacket(List<ResourceLocation> powerIds) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, UseActivePowerTypesC2SPacket> PACKET_CODEC = PacketCodec.tuple(
        PacketCodecs.collection(ArrayList::new, ResourceLocation.PACKET_CODEC), UseActivePowerTypesC2SPacket::powerIds,
