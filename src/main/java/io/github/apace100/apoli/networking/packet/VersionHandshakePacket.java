...
public record VersionHandshakePacket(int[] semver) implements CustomPayload {
    ...
    public static final PacketCodec<FriendlyByteBuf, VersionHandshakePacket> PACKET_CODEC = PacketCodec.of(VersionHandshakePacket::write, VersionHandshakePacket::read);
