...
public record DismountPlayerS2CPacket(int id) implements CustomPayload {
    ...
    public static final PacketCodec<FriendlyByteBuf, DismountPlayerS2CPacket> PACKET_CODEC = PacketCodecs.VAR_INT.xmap(DismountPlayerS2CPacket::new, DismountPlayerS2CPacket::id).cast();
