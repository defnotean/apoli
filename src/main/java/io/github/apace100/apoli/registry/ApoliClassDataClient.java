...
public class ApoliClassDataClient {
    ...
    public static final ClassDataRegistry<RenderLayer<?, ?>> FEATURE_RENDERERS = ClassDataRegistry.getOrCreate(ClassUtil.castClass(RenderLayer.class), "RenderLayer");

    public static void registerAll() {
        // TODO: MC 26.1 - FeatureRenderer renamed to RenderLayer. Subclass names in layers package
        // need verification against the actual 26.1 jar. The base class is RenderLayer but subclass
        // names may differ. Comment out individual mappings that fail and fix as needed.
        ...
        // FEATURE_RENDERERS.addMapping("armor", HumanoidArmorLayer.class);
